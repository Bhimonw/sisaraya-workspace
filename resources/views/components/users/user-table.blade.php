                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ route('admin.users.edit', $user) }}" 
                                   class="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 hover:scale-105 active:scale-95 transition-all shadow-sm">
                                ...
                                @if($canDelete && $user->id !== auth()->id())
                                    <form method="POST" 
                                        ...
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="inline-flex items-center gap-1 px-3 py-1.5 bg-red-500 text-white font-medium rounded-lg hover:bg-red-600 hover:scale-105 active:scale-95 transition-all shadow-sm">
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
